...
database/                 cluster bootstrap and forward-only migrations
packages/contracts/       agent contracts, schema-validated
...
| Assurance controls | 70, totalling 136 weighted points |
| Accessibility | 25 surfaces × 2 colour schemes × 2 text directions = 100 scans, 0 violations |
| Tools | 16 declared, 9 implemented, 7 marked NOT_IMPLEMENTED and refused by the planner |

<sub>Generated by `scripts/repo_facts.py`; `tests/api/test_repository_hygiene.py` fails when it drifts.</sub>
<!-- repo-facts:end -->
